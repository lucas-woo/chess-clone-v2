...
func (x *SaveUserScoreRequest) GetScore() int32 {
	if x != nil {
		return x.Score
	}
	return 0
...
type GetUserProfileResponse struct {
	...
	HighScore      int32                  `protobuf:"varint,3,opt,name=high_score,json=highScore,proto3" json:"high_score,omitempty"`
...
func (x *GetUserProfileResponse) GetHighScore() int32 {
	if x != nil {
		return x.HighScore
	}
	return 0
...
var file_users_v1_users_proto_rawDesc = string([]byte{
	...
	0x05, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x31, 0x0a, 0x15, 0x53, 0x61, 0x76, 0x65,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x68, 0x69, 0x67, 0x68, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12,
